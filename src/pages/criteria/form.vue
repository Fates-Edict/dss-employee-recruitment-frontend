    ...
    <q-form @submit.prevent="onSubmit" class="col-12 row" autocomplete="off">
      ...
      <CardGeneral>
        <div class="col-12 row q-col-gutter-md">
          ...
          <q-select class="col-12 col-md-4" outlined :options="$Helper.criteriaType()" :error="errors.type ? true : false" :error-message="errors.type" v-model="dataModel.type" :label="$Lang.type" dense />
        </div>
      </CardGeneral>
    </q-form>
  </div>
